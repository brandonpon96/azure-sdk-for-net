...
namespace Microsoft.AzureStack.Infra.Admin
{
    ...
    /// </summary>
    internal partial class AlertsOperations : IServiceOperations<InfraAdminClient>, IAlertsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal AlertsOperations(InfraAdminClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Alert>>> ListWithHttpMessagesAsync(string region, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/system.{region}/providers/Microsoft.InfrastructureInsights.Admin/regionHealths/{region}/Alerts").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<string>> GetWithHttpMessagesAsync(string region, string alertName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
