...
namespace Microsoft.AzureStack.Infra.Admin.Models
{
    ...
    /// TODO
    /// </summary>
    public partial class InfraRoleInstance : ResourceBase
    {
        /// <summary>
        ...
        public InfraRoleInstance(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), InfraRoleInstanceProperties properties = default(InfraRoleInstanceProperties))
        ...
        public InfraRoleInstanceProperties Properties { get; set; }
